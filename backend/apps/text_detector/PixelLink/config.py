...
crop_size = (1280, 1280)
random_resize = np.arange(1600, 2816, 32)
...
def _set_OHEM_img_threshold(images_loss):
    ...
    OHEM_img_threshold = value[int(len(value)*0.99)]
...
root_images_dir = "/home/gem/ocr/ToolLabel/"
data_label_dirs = "media/japan_images/"
file_xml_detection = "japan_gt.xml"
root_xml_dir = "/home/gem/ocr/ToolLabel/media/xml_japan_annotation/"

# Deployment 
use_device = False
model_path = "/home/gem/phucph/OCR/backend/models/text_detector/model_japan_1280_v2.pth"