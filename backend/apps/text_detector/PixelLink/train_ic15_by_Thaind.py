...
def train(train_loader,data_loader, images_loss, model, criterion, optimizer, epoch, start_epoch, writer=None, val_loader=None):
    import config 
...
def main(args):
    ...
    print('train ban đầu: ',len(train_loader1))
    ...
    for epoch in range(start_epoch, args.n_epoch):
        ...
        train_loss, train_te_acc, train_te_iou = train(train_loader,data_loader,images_loss, model, dice_loss, optimizer, epoch,start_epoch,writer)
        val_loss, val_te_acc, val_te_iou = train(validation_loader,data_loader,images_loss, model, dice_loss, optimizer, epoch,start_epoch,writer, val_loader=True)
        
        train_losses.append(train_loss)
        val_losses.append(val_loss)
        train_acc.append(train_te_acc)
        val_acc.append(val_te_acc)
